...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        const fetchTouristData = async () => {
            try {
                const response = await fetch(`http://localhost:8000/api/tour-guides/profile/${id}`, {
                    method: 'GET',
                    headers: {
                ...
                console.log("this is the data in drop : ", data )
                setTourist(data);
    ...
    return (
      ...
      `}
            ...
            <div className="profile" ref={dropdownRef}>
               ...
               {tourist &&  (<img className="levelBadge"
          src={`http://localhost:8000/${tourist.profileImage}`}
          alt="Profile"
        />
            )}    </button>
                ...
                {isDropdownOpen && (
                    <div className="dropdown">
                        <ul>
                            <li>
                                <Link to={`/Tourguide/${id}/profile/tour-guides/${id}`} className="dropdownItem">
