            ...
            <div className="profile" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                    <div className="dropdown">
                        <ul>
                            <li>
                                <Link to={`/Advertisers/${id}/advertiserprofile`} className="dropdownItem">
                                    <i className="fas fa-user"></i>
                                    <span>Profile</span>
                                </Link>
                            </li>
                            <li>
                                <Link to={`Advertisers/${id}/change-password/${modelName}`} className="dropdownItem">
