    ...
    return (
        <div className="home">
            ...
            <div className="header-container">
                ...
                <button className="add-button" onClick={() => setIsCreateModalOpen(true)}> + </button></div>
                    ...
                    {filteredHistLocs.map((histloc) => (
                        <div className="histloc-card" key={histloc._id}>
                            <div className="card-header">
                                ...
                                <a class="card-action" href="#" onClick={() => handleEditClick(histloc)}><i class="fa-solid fa-pen"></i></a>
                            </div>
